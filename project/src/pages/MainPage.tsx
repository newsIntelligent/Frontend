    ...
    const data = [
        {
            ...
            description: "2025년 4월, SK텔레콤의 핵심 가입자 인증 서버인 HSS(Home Subscriber Server)가 해킹당해 약 9.7GB 규모의 유심(USIM) 관련 정보가 유출되었습니다. 2차 범죄로 이어질 우려가 제기되었습니다 . 2025년 4월, SK텔레콤의 해킹당해 약 9.7GB 규모의 유심(USIM) 관련 정보가 들어왔스빈다",
        ...
        },
        {
            ...
            description: "2025년 4월, SK텔레콤의 핵심 가입자 인증 서버인 (Home Subscriber Server)가 해킹당해 약 9.7GB 규모의 유심(USIM) 관련 정보가 유출되었습니다. 이것은 강아지 콩이가 콩콩",
            imageUrl: "/src/assets/img.jpg",
            imgSource: "조선일보 '고양이가 크게 울면 안 돼 울면 안 돼'",
            updatedAt: "05/03 23:50"
        },
