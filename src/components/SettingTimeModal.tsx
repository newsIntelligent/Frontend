...
const SettingTimeModal = ({onAdd, onCancel} : SettingTimeModalProps) => {
    ...
    return (
        <div className="absolute mx-30 bg-white flex mt-4 w-[200px] h-[160px] pt-[10px] pr-[10px] pl-[10px] pb-[44px] rounded-[8px] shadow-[1px_1px_8px_0px_#00000040] items-center justify-center flex-col">
